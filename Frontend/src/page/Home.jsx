    ...
    return(
        <>
            <div className="ml-72 mt-6 mr-6 flex justify-between">
                ...
                <div>
                    <button 
                      className="mx-2 py-2 px-4 border-solid border-2 border-green-500 hover:bg-[#28a745] group"
                      type="button"
                      onClick={() => setShowModal(true)}
                    >
                        <svg className="w-3 h-3 group-hover:stroke-white stroke-[#28a745]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                    ...
                    <div className="relative w-auto my-6 mx-auto max-w-3xl">
                      <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        <div className="flex items-start justify-between p-5 border-b border-solid border-gray-300 rounded-t ">
                          ...
                          >
                            <span className="text-black h-6 w-6 text-xl">
                              x
                            </span>
                          </button>
                        </div>
                          ...
                          <form className="w-full max-w-lg">
                            <div className="flex flex-wrap -mx-3 mb-2">
                              <div className="w-full px-3 mb-6 md:mb-0">
                                ...
                                <input className="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="text" placeholder="Add title" />
                            ...
                            <div className="flex flex-wrap -mx-3 mb-2">
                              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="date" placeholder="Set date" />
                              </div>
                              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="time">
                                  Time
                                </label>
                                <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="time" placeholder="Set time" />
                              </div>
                            </div>
                            ...
                            <div className="flex flex-wrap -mx-3 mb-6">
                              <div className="w-full px-3 mb-6 md:mb-0">
                                ...
                                <textarea rows={4} className="block p-2.5 w-full text-sm text-gray-500 bg-gray-200 rounded-lg border border-gray-300 leading-tight focus:outline-none focus:bg-white" defaultValue={""} type="text" placeholder="Add description"/>
